...
declare type GetRcSocketEventType<EventName extends RcSocketEventName> = Parameters<NonNullable<RcSocket[EventName]>>[0];
export default class RcSocket<Message extends RcSocketMessage = RcSocketMessage> {
     ...
     */
    protected _stateChanged<EventName extends RcSocketEventName>(readyState: RcSocketReadyState, evtName: EventName, evt?: GetRcSocketEventType<EventName>): void;
    /**
     ...
     */
    protected _trigger<EventName extends RcSocketEventName>(evtName: EventName, evt?: GetRcSocketEventType<EventName>): void;
}
export {};
