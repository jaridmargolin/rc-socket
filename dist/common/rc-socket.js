...
function (_EventTarget) {
  _inheritsLoose(RcSocket, _EventTarget);
  ...
  _proto.addEventListener = function addEventListener(type, listener, options) {
    ...
    _EventTarget.prototype.addEventListener.call(this, type, listener, options);
  ...
  _proto.removeEventListener = function removeEventListener(type, listener, options) {
    ...
    _EventTarget.prototype.removeEventListener.call(this, type, listener, options);
  }
  /**
  ...
  _proto._getListenerKey = function _getListenerKey(type, options) {
    var capture = typeof options === 'object' ? options.capture : options; // Using an obscure emoji as a separator to reduce any collisions that
    // could occur with custom event types. Example: `message:1234`

    return typeof capture === 'boolean' ? type + "\uD83D\uDEA7" + capture.toString() : type + "\uD83D\uDEA7undefined";
  }
  /**
  ...
  _proto._trigger = function _trigger(evtHandlerName, evt) {
    var event = typeof evt === 'undefined' ? new Event(evtHandlerName.slice(2)) : new evt.constructor(evt.type, evt);
